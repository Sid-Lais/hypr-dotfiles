...
- Using <kbd>yay</kbd>
    ```sh
    yay -S tofi base-devel pokemon-colorscripts-git hyprland hyprpicker xdg-desktop-portal-hyprland waybar cava kitty wofi starship wl-clipboard swww swaync hyprlock hypridle tty-clock-git playerctl pavucontrol btop mpd mpd-mpris mpv mpv-mpris qt5-base qt5-wayland qt6-base qt6-wayland lsd geany bat cliphist gamemode polkit-gnome wlogout visual-studio-code-bin boo-grub-git sddm-git boo-sddm-git proxzima-plymouth-git yad blueman network-manager-applet libinput-gestures light grim slurp auto-cpufreq --needed yay
    ```
